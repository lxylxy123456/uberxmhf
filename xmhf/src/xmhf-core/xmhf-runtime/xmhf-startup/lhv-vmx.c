...
vcpu->vmcs.control_exception_bitmap=0x00000000;
vcpu->vmcs.control_pagefault_errorcode_mask=0x00000000;
vcpu->vmcs.control_pagefault_errorcode_match=0x00000000;
vcpu->vmcs.control_CR3_target_count=0x00000000;
vcpu->vmcs.control_VM_exit_controls=0x00036dff;
vcpu->vmcs.control_VM_exit_MSR_store_count=0x00000003;
vcpu->vmcs.control_VM_exit_MSR_load_count=0x00000003;
vcpu->vmcs.control_VM_entry_controls=0x000011ff;
vcpu->vmcs.control_VM_entry_MSR_load_count=0x00000003;
vcpu->vmcs.control_VM_entry_interruption_information=0x00000000;
vcpu->vmcs.control_VM_entry_exception_errorcode=0x00000000;
vcpu->vmcs.control_VM_entry_instruction_length=0x00000000;
vcpu->vmcs.control_Task_PRivilege_Threshold=0x00000000;
vcpu->vmcs.control_CR0_mask=0x0000000060000020;
vcpu->vmcs.control_CR4_mask=0x0000000000002000;
vcpu->vmcs.control_CR0_shadow=0x0000000000000010;
vcpu->vmcs.control_CR4_shadow=0x0000000000000000;
vcpu->vmcs.control_IO_BitmapA_address=0x000000001c6f7000;
vcpu->vmcs.control_IO_BitmapB_address=0x000000001c6f8000;
vcpu->vmcs.control_MSR_Bitmaps_address=0x0000000000000000;
vcpu->vmcs.control_VM_exit_MSR_store_address=0x000000001c6d7000;
vcpu->vmcs.control_VM_exit_MSR_load_address=0x000000001c6e7000;
vcpu->vmcs.control_VM_entry_MSR_load_address=0x000000001c6d7000;
vcpu->vmcs.control_TSC_offset=0x0000000000000000;
vcpu->vmcs.control_virtual_APIC_page_address=0x0000000000000000;
vcpu->vmcs.control_EPT_pointer=0x000000001869501e;
vcpu->vmcs.host_CR0=0x0000000080000035;
vcpu->vmcs.host_CR3=0x000000001d039000;
...
vcpu->vmcs.host_SYSENTER_CS=0x00000000;
vcpu->vmcs.host_ES_selector=0x00000010;
vcpu->vmcs.host_CS_selector=0x00000008;
vcpu->vmcs.host_SS_selector=0x00000010;
vcpu->vmcs.host_DS_selector=0x00000010;
vcpu->vmcs.host_FS_selector=0x00000010;
vcpu->vmcs.host_GS_selector=0x00000010;
vcpu->vmcs.host_TR_selector=0x00000018;
vcpu->vmcs.guest_CR0=0x0000000000000031;
vcpu->vmcs.guest_CR3=0x0000000000000000;
vcpu->vmcs.guest_CR4=0x0000000000002000;
vcpu->vmcs.guest_ES_base=0x0000000000000000;
vcpu->vmcs.guest_CS_base=0x0000000000000000;
vcpu->vmcs.guest_SS_base=0x0000000000000000;
vcpu->vmcs.guest_DS_base=0x0000000000000000;
vcpu->vmcs.guest_FS_base=0x0000000000000000;
vcpu->vmcs.guest_GS_base=0x0000000000000000;
vcpu->vmcs.guest_LDTR_base=0x0000000000000000;
vcpu->vmcs.guest_TR_base=0x0000000000000000;
vcpu->vmcs.guest_GDTR_base=0x000000000167ff60;
vcpu->vmcs.guest_IDTR_base=0x0000000000000000;
vcpu->vmcs.guest_DR7=0x0000000000000400;
vcpu->vmcs.guest_RSP=0x0000000001694238;
vcpu->vmcs.guest_RIP=0x0000000001672fa8;
vcpu->vmcs.guest_RFLAGS=0x0000000000000016;
vcpu->vmcs.guest_pending_debug_x=0x0000000000000000;
vcpu->vmcs.guest_SYSENTER_ESP=0x0000000000000000;
vcpu->vmcs.guest_SYSENTER_EIP=0x0000000000000000;
...
vcpu->vmcs.guest_LDTR_limit=0x00000000;
vcpu->vmcs.guest_TR_limit=0x00000000;
vcpu->vmcs.guest_GDTR_limit=0x0000002f;
vcpu->vmcs.guest_IDTR_limit=0x00000000;
vcpu->vmcs.guest_ES_access_rights=0x0000c093;
vcpu->vmcs.guest_CS_access_rights=0x0000c09b;
vcpu->vmcs.guest_SS_access_rights=0x0000c093;
vcpu->vmcs.guest_DS_access_rights=0x0000c093;
vcpu->vmcs.guest_FS_access_rights=0x0000c093;
vcpu->vmcs.guest_GS_access_rights=0x0000c093;
vcpu->vmcs.guest_LDTR_access_rights=0x00010000;
vcpu->vmcs.guest_TR_access_rights=0x0000008b;
vcpu->vmcs.guest_interruptibility=0x00000000;
vcpu->vmcs.guest_activity_state=0x00000000;
vcpu->vmcs.guest_SYSENTER_CS=0x00000000;
vcpu->vmcs.guest_ES_selector=0x00000018;
vcpu->vmcs.guest_CS_selector=0x00000010;
vcpu->vmcs.guest_SS_selector=0x00000018;
vcpu->vmcs.guest_DS_selector=0x00000018;
vcpu->vmcs.guest_FS_selector=0x00000018;
vcpu->vmcs.guest_GS_selector=0x00000018;
vcpu->vmcs.guest_LDTR_selector=0x00000000;
vcpu->vmcs.guest_TR_selector=0x00000000;
vcpu->vmcs.guest_VMCS_link_pointer=0x00000000ffffffff;
vcpu->vmcs.guest_IA32_DEBUGCTL=0x0000000000000000;
vcpu->vmcs.guest_paddr=0x0000000000000000;
vcpu->vmcs.guest_PDPTE0=0x0000000000000000;
vcpu->vmcs.guest_PDPTE1=0x0000000000000000;
vcpu->vmcs.guest_PDPTE2=0x0000000000000000;
vcpu->vmcs.guest_PDPTE3=0x0000000000000000;
vcpu->vmcs.info_vminstr_error=0x00000000;
vcpu->vmcs.info_vmexit_reason=0x0000001f;
vcpu->vmcs.info_vmexit_interrupt_information=0x00000000;
vcpu->vmcs.info_vmexit_interrupt_error_code=0x00000000;
vcpu->vmcs.info_IDT_vectoring_information=0x00000000;
vcpu->vmcs.info_IDT_vectoring_error_code=0x00000000;
vcpu->vmcs.info_vmexit_instruction_length=0x00000002;
vcpu->vmcs.info_vmx_instruction_information=0x00000000;
vcpu->vmcs.info_exit_qualification=0x0000000000000000;
vcpu->vmcs.info_guest_linear_address=0x0000000000000000;
	vmcs_load(vcpu);
